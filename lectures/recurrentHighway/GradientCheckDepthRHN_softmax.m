...
%     for layer = 2:depth
%         fprintf('Check gW_R_H%d:%.10f\n', layer, norm(gW_R_H_Check{layer}-gW_R_H));
%         fprintf('Check gW_R_T%d:%.10f\n', layer, norm(gW_R_T_Check{layer}-gW_R_T));
%     end
    fprintf('Check gW_R_H%d:%.10f\n', layer_idx, norm(gW_R_H_Check-gW_R_H{layer_idx}));
    fprintf('Check gW_R_T%d:%.10f\n', layer_idx, norm(gW_R_T_Check-gW_R_T{layer_idx}));
